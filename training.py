...
def train():
	...
	DATA_PATH = "/Users/abdulrahimiliasu/Downloads/symptomPrediction/Training.csv"
	...
	test_data = pd.read_csv("/Users/abdulrahimiliasu/Downloads/symptomPrediction/Testing.csv").dropna(axis=1)
